...
export default function Book() {
    const bookDetails = {
        ...
        authorNote: "Mot de l'autrice : J’ai passé un merveilleux moment à décrire le quotidien et les aventures des quatre amis, Théophile, Arthur, Ambre et Jérémie sur leur terre ainsi que sur Astrhäle",
    }
    ...
    return (
        <main className={styles.main_book}>
            ...
            <div className={styles.book_content_wrapper}>
                <BookContent detail={bookDetails} links={bookLinks} reviews={bookReviews} cover={bookCover} />
            </div>
        </main>
    )
}
